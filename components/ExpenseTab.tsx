  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <button 
        ...
        className={`w-full py-4 text-white rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:shadow-none active:translate-y-1 transition-all flex items-center justify-center gap-2 font-black text-lg border-2 border-black ${
            showForm ? 'bg-slate-800' : 'bg-[#E76F51]'
        }`}
      >
